...
<!-- 说明要解决的问题、用户场景和为什么需要这次改动。 -->

## 主要改动

<!-- 用简短列表说明实现范围；不要夹带无关变更。 -->
...
- [ ] 已更新 `CHANGELOG.md` 的 `Unreleased`，或已在说明中写明不适用

## 安全、隐私与素材

- [ ] 没有提交 `data/`、AppData 运行目录、日志、凭据、token、个人绝对路径或真实用户命令
- [ ] 截图、录屏、日志和示例已经脱敏
